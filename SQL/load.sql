...
('sib170121', '2024-10-28', 'Met with the professor for the standup meeting', '0:30'),
('sib170121', '2024-10-29', 'Watched videos on the set up for the web pages in C#', '1:15'),
('sib170121', '2024-10-31', 'Met with team members to discuss next steps.', '2:00'),
('sib170121', '2024-11-01', 'Worked on the student front end framework', '2:00'),
('sib170121', '2024-11-03', 'Made the bare bones student web pages and got the files set up correctly', '4:00'),
('sib170121', '2024-11-04', 'Made the student login page', '0:45'),
('sib170121', '2024-11-08', 'Made the student timesheet month and project views', '1:30'),
('sib170121', '2024-11-10', 'Made the student peer review login page', '0:45'),
('sib170121', '2024-11-11', 'Made the student peer review review page', '1:15'),
('sib170121', '2024-11-13', 'Connected the student login with the database', '0:45'),
('sib170121', '2024-11-16', 'Connected the student delete timeslot with the database', '0:45'),
('sib170121', '2024-11-18', 'Connected the student edit timeslot with the database', '0:45'),
('sib170121', '2024-11-24', 'Worked on the student peer review front end', '3:00'),
('sib170121', '2024-11-27', 'Worked on the presentation slides', '0:30'),
('sib170121', '2024-11-29', 'Completed my part of the project and met with the team', '3:00'),
('sib170121', '2024-12-01', 'Finished up the testing for the project', '2:00'),
